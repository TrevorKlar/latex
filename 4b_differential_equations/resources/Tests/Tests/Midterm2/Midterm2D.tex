...
\centerline{\bf \underline{Version D}}
\vskip0.2in
...
\begin{questions}
 ...
 \question[9] A 10 kg mass is attached to the end of a spring with spring constant $k=150$ N/m.
 
 \begin{parts}
  \part If there is no damping force, at what frequency will the mass naturally oscillate?
  \vfill
  \part If we add a dashpot to the system with a damping constant of $b=80$ N/(m/s), will the system be over-damped or under-damped?
  \vfill
  \part If we keep the damping consant of $b=80$ N/(m/s) from part (b) but replace the spring, what new spring constant $k$ will cause the system to be critically damped?
  \vfill
 \end{parts}
 ...
 \begin{parts}
  ...
  \includegraphics[width=0.4\textwidth]{xtplaneD} \qquad\includegraphics[width=0.4\textwidth]{ytplaneD}
