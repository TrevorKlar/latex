...
\begin{center}\textbf{Math 34A Midterm 1, Spring 2022}\end{center}
\begin{enumerate}
...
$$\frac{\sqrt[3]{x^{-6}y^{-3}}}{ab^{-1}}\cdot \left( \frac{xy}{ab^{-1}} \right)^{-2}$$
\vspace{230pt} \\ \phantom{.} \hfill$ \ $ \ansbox{200}{140} 
...
\vfill \\ \phantom{.} \hfill$ \ $ \ansbox{300}{70} \\ \\
...
\vfill \\ 
\phantom{.} \hfill \ansbox{200}{50} \ minutes. 



%%%%%%%%%%% (5)
\newpage
\item ({\it 4pts}) A farmer wants to raise cattle in his pasture, but he first needs fencing. The field is twice as wide as it is long. Fencing purchases are \$35 plus \$5 per foot of fencing. Express the costing of fencing for the perimeter in terms of the length of the field. 
\vfill \\ \phantom{.} \hfill Fencing Cost$ \ = \ \$$ \ansbox{250}{70}  \\ \\
%%%%%%%%%%% (6)
\newpage

\item ({\it 5 points})   
The aspect ratio of a screen is the ratio of the width to the height. You are considering the purchase of a 45in TV (TV sizes are measured by the diagonal, not the length or width). In addition to this information, the manufacturer will only disclose the height of the TV, not the width. Express the aspect ratio in terms of the height $h$ of the TV in inches. 
\vfill \\ 
\phantom{.} \hfill Aspect Ratio $ = \ $ \ansbox{240}{140} \\
\vspace{10pt} \\ 
...
\begin{enumerate} 
\item {\large $\underset{x \rightarrow 2}{\lim}$} \ \ {\large $15x-10$} \\ \\ \phantom{.} \hfill\ansbox{140}{70} \\ \\  
\item {\large $\underset{x \rightarrow \infty}{\lim} \ \ $} {\Large $\frac{5x-3}{10x+17}$} \\ \\ \phantom{.} \hfill\ansbox{140}{70} \\ \\  
\item {\large $\underset{n \rightarrow 0}{\lim}$} \ \ {\Large$\frac{2x^2+4x}{2x}$} \\ \\ \phantom{.} \hfill\ansbox{140}{70} \end{enumerate}


%%%%%%%%%%% (8)
\item ({\it 3 points}) Compute the logarithms below. 
\begin{enumerate} 
\item $\log_2(32)$ \\ \phantom{.} \hfill\ansbox{140}{70} \\ \\  
\item $\log_{10}(.001)$ \\ \phantom{.} \hfill\ansbox{140}{70} \\ \\  
\item $\log_{7}(49)$ \\ \phantom{.} \hfill\ansbox{140}{70} \\ \\  
\end{enumerate}
