...
\begin{enumerate} 
\item {\large $\underset{x \rightarrow 3}{\lim}$} \ \ {\large $5x-10$} \\ \\ \phantom{.} \hfill\ansbox{140}{70} \\ \\  
\item {\large $\underset{x \rightarrow \infty}{\lim} \ \ $} {\Large $\frac{2x-3}{6x+17}$} \\ \\ \phantom{.} \hfill\ansbox{140}{70} \\ \\  
\item {\large $\underset{n \rightarrow 0}{\lim}$} \ \ {\Large$\frac{2x^2+6x}{2x}$} \\ \\ \phantom{.} \hfill\ansbox{140}{70} \end{enumerate}


%%%%%%%%%%% (8)
\item ({\it 3 points}) Compute the logarithms below. 
\begin{enumerate} 
\item $\log_2(16)$ \\ \phantom{.} \hfill\ansbox{140}{70} \\ \\  
\item $\log_{10}(.1)$ \\ \phantom{.} \hfill\ansbox{140}{70} \\ \\  
\item $\log_{5}(125)$ \\ \phantom{.} \hfill\ansbox{140}{70} \\ \\  
\end{enumerate}
